...
describe("GeoJSON serializing", () => {
  ...
  describe("GeoJSON from MultiPoint", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("multipoint.shp", "multipoint.shx", ShapeType.MultiPoint, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
  ...
  describe("GeoJSON from MultiPointM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("multipointM.shp", "multipointM.shx", ShapeType.MultiPointM, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
      geoJsonAssert(reader.readGeom(1).toGeoJson());
      geoJsonAssert(reader.readGeom(2).toGeoJson());
    });
  ...
  describe("GeoJSON from MultiPointZM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("multipointZM.shp", "multipointZM.shx", ShapeType.MultiPointZ, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
      geoJsonAssert(reader.readGeom(1).toGeoJson());
      geoJsonAssert(reader.readGeom(2).toGeoJson());
    });
  ...
  describe("GeoJSON from PolyLine", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polyline.shp", "polyline.shx", ShapeType.PolyLine, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
      geoJsonAssert(reader.readGeom(1).toGeoJson());
      geoJsonAssert(reader.readGeom(2).toGeoJson());
    });
  ...
  describe("GeoJSON from PolyLineM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polylineM.shp", "polylineM.shx", ShapeType.PolyLineM, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
      geoJsonAssert(reader.readGeom(1).toGeoJson());
      geoJsonAssert(reader.readGeom(2).toGeoJson());
    });
  ...
  describe("GeoJSON from PolyLineZM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polylineZM.shp", "polylineZM.shx", ShapeType.PolyLineZ, 3);
      geoJsonAssert(reader.readGeom(0).toGeoJson());
      geoJsonAssert(reader.readGeom(1).toGeoJson());
      geoJsonAssert(reader.readGeom(2).toGeoJson());
    });
  ...
  describe("GeoJSON from Polygon", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polygon.shp", "polygon.shx", ShapeType.Polygon, 3);
  ...
  describe("GeoJSON from PolygonM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polygonM.shp", "polygonM.shx", ShapeType.PolygonM, 2);
      // NOTE: The current version of geojsonhint has a bug in polygon orientation checks, wait for new version
      //geoJsonAssert(reader.readGeom(0).toGeoJson());
      //geoJsonAssert(reader.readGeom(1).toGeoJson());
    });
  ...
  describe("GeoJSON from PolygonZM", () => {
    it("", async () => {
      let reader = await createAndVerifyReader("polygonZM.shp", "polygonZM.shx", ShapeType.PolygonZ, 2);
      // NOTE: The current version of geojsonhint has a bug in polygon orientation checks, wait for new version
      //   geoJsonAssert(reader.readGeom(0).toGeoJson());
      //   geoJsonAssert(reader.readGeom(1).toGeoJson());
    });
